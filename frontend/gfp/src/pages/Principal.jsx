...
export default function Principal() {
    ...
    return (
        <div className='flex h-screen font-sans bg-gradient-to-b from-[#1b0202] to-[#db3434]'>
            ...
            {/* Sidebar */}
            <section className={`fixed top-0 left-0 h-full w-64 bg-black
                ...
                <div className='flex justify-between items-center mb-6 p-4 
                    ...
                    <div className='flex gap-2 items-center'>
                        <img src="https://media.tenor.com/rysQ0YYMcxEAAAAj/cogumelo-mario-bros.gif" alt='Logo GFP' className='w-18 h-18' />
                    ...
                    <div className='px-4 lg:px-6 mb-2'>
                        <Link to='/dashboard' onClick={() => setMenuAberto(false)}
                            className={`flex items-center gap-2 p-3 rounded-lg transition-colors
                                    ...
                                    'bg-red-600 text-white shadow-md' : 'hover:bg-red-800'
                                }
                                `}
                        >
                ...
                <div className='p-4 lg:p-6 border-t border-black bg-red-600
                        hover:bg-red-800 text-white font-bold py-2 px-4 rounded-lg m-4
                '>
                ...
                <div className='border-t border-red-700 pt-4'>
                    <div className='flex items-center p-2'>
                        <MdPeople className='w-10 h-10 p-2 bg-red-700
